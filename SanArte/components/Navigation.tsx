...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      ...
      <nav className="hidden md:flex fixed top-0 w-full bg-[#050b0d]/50 backdrop-blur-xl border-b border-white/5 py-4 pt-[calc(1rem+env(safe-area-inset-top))] px-8 z-[90] justify-between items-center transition-all duration-300">
      ...
      <nav className="fixed bottom-0 w-full bg-[#050b0d]/80 backdrop-blur-xl border-t border-white/5 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] px-6 z-[90] flex justify-between items-center md:hidden shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
